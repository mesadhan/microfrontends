            ...
            <tbody className="block md:table-row-group">
                ...
                {visitedPagesStatistics.map((page, index) => (
                    ...
                    <tr key={index} className="border border-grey-500 md:border-none block md:table-row">
                        <td className="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span className="inline-block w-1/3">{page.url} </span></td>
                        <td className="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span className="inline-block w-1/3">{page.counter} </span></td>
                        <td className="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span className="inline-block w-1/3">{parseDate(page.created_at)} </span></td>
                        <td className="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span className="inline-block w-1/3">{parseDate(page.updated_at)} </span></td>
                    </tr>
