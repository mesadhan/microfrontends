...
export default function CartSidePanel() {
    ...
    return (
      <Transition.Root show={isShowCartPanel} as={Fragment}>
      <Dialog as="div" className="relative z-10" onClose={toggleCartPanel}>
        <Transition.Child
          as={Fragment}
                      ...
                      <div className="mt-8">
                        <div className="flow-root">
                          <ul role="list" className="-my-6 divide-y divide-gray-200">
                            {cart.map((product) => (
                              <li key={product.idDrink} className="flex py-6">
                                ...
                                <div className="ml-4 flex flex-1 flex-col">
                                  <div>
                                    <div className="flex justify-between text-base font-medium text-gray-900">
                                      <h3>
                                        <a href={product.href}>{product.idDrink}</a>
                                      </h3>
