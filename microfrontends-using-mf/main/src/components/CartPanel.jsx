        ...
        <div className="cart-panel p-3">
          ...
          <div className="cart-panel-header">
            <div className="row">
              ...
              <div className="col-2">
                <button onClick={toggleCartPanel} className="btn btn-danger btn-sm" type="button">Close
                </button>
              </div>
            </div>
          </div>
              ...
              cart.map((product, index) => (
                <div key={index} className="card-box p-2 mb-2">
                  ...
                  <div className="row border-1">
                    ...
                    <div className="col-2">
                      <button onClick={() => removeFromCart(product.idDrink)} className="btn btn-outline-danger btn-sm" type="button">X
                      </button>
                    </div>
                  </div>
          ...
          <button type="button" onClick={() => toggleCartPanel(false)}
